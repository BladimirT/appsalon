...
class Email {
    ...
    public function enviarConfirmacion() {
        ...
        $contenido .= "<p>Si tuno solicitaste esta cuenta, puedes ignorar el mensaje</p>";
        $contenido .= "</html>";
        $mail->Body = $contenido;
    ...
    public function enviarInstrucciones() {
        ...
        $contenido = "<html>";
        $contenido .= "<p><strong>Hola " . $this->nombre . "</strong> Has solicitado reestablecer tu password, click en el siguente enlace para haerlo.</p>";
